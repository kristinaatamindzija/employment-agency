...
insert into subscription_plan(id, product_id, merchant_uuid, plan_paypal_id) values(nextval('plan_id_seq'), 4, '12345678-1234-1234-1234-123456789012', 'P-82T63888Y87914132MOPPK7Y');